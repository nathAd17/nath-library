                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        <div class="bg-gradient-to-r from-cyan-50 to-cyan-200 rounded-xl p-6 text-dark transform hover:scale-105 transition-transform duration-200 shadow-lg">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="bg-primary bg-opacity-30 rounded-lg p-3">
                                ...
                                <template x-for="(user, index) in topUsers" :key="user.id">
                                    <div class="flex items-center justify-between p-3 bg-light rounded-lg hover:bg-lighthover transition-colors">
                                        <div class="flex items-center space-x-3">
                                            <div class="w-8 h-8 bg-gradient-to-r from-blue-200 to-blue-400 rounded-full flex items-center justify-center text-light font-bold text-sm"
                                                 x-text="index + 1"></div>
                                            <div>
