                ...
                <table class="w-full">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-medium text-light uppercase tracking-wider">Deskripsi
                            </th>
                            ...
                            <tr class="hover:bg-light">
                                ...
                                <td class="px-6 py-4 lightspace-nowrap">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="text-xs text-light">buku</span>
                                    </div>
                                </td>
                        ...
                        <div class="grid grid-cols-1 gap-6" x-show="selectedCategory">
                            <div class="md:col-span-2 space-y-4">
                                ...
                                <div class="grid grid-flow-col auto-cols-max gap-8 text-sm">
                                    <div>
                                        <span class="font-medium text-dark">Nama:</span>
                    ...
                    <div class="bg-light px-6 pt-6 pb-4">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-light">Apakah Anda yakin ingin menghapus kategori ini?</p>
                            </div>
                        </div>

                        <div class="bg-light p-4 rounded-lg" x-show="categoryToDelete">
                        ...
                        <p class="text-sm text-light mt-4">Data kategori yang dihapus tidak dapat dikembalikan. Pastikan
